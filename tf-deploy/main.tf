...
resource "aws_instance" "api_server" {
    ...
    user_data = templatefile("${path.module}/build-apiserver-vm.tpl", {            
        mysql_server_endpoint = aws_db_instance.mysql_server.endpoint
    })
...
resource "aws_instance" "web_server" {
    ...
    user_data = templatefile("${path.module}/build-webserver-vm.tpl", { api_server_ip = aws_instance.api_server.public_ip })
